...
# -*- coding: utf-8 -*-
"""
DDPG + Spatial Attention 训练脚本
在DDPG基础上增加空间注意力机制，用于LiDAR特征提取
"""
...
def train(args):
    print("=" * 60)
    print("DDPG + Spatial Attention Navigation Training")
    print("=" * 60)
    ...
    print(f"  Sectors: {args.n_sectors}")
...
def parse_args():
    p = argparse.ArgumentParser(description="DDPG + Spatial Attention Navigation Training")
    ...
    p.add_argument("--sector_embed_dim", type=int, default=32,
                   help="Embedding dimension for LiDAR sectors")
